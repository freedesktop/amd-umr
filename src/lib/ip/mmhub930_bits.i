...
static struct umr_bitfield mmMMEA0_ADDRNORMDRAM_TRICHANNEL_CFG[] = {
...
static struct umr_bitfield mmMMEA1_ADDRNORMDRAM_HOLE_CNTL[] = {
	 { "DRAM_HOLE_VALID", 0, 0, &umr_bitfield_default },
	 { "DRAM_HOLE_OFFSET", 7, 15, &umr_bitfield_default },
};
static struct umr_bitfield mmMMEA1_ADDRNORMDRAM_TRICHANNEL_CFG[] = {
	 { "LOG2_ADDR64K_SPACE", 0, 5, &umr_bitfield_default },
};
